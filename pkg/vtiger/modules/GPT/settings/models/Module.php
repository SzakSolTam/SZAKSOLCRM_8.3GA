...
class Settings_GPT_Module_Model extends Settings_Vtiger_Module_Model{
    ...
    public function getModule($raw=true) {
		$moduleName = Settings_GPT_Module_Model::getModuleName();
		if(!$raw) {
    ...
    public function getMenuItem() {
        $menuItem = Settings_Vtiger_MenuItem_Model::getInstance('LBL_GPT');
        return $menuItem;
    }
