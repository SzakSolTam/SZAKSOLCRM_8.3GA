...
{strip}
        <div class="row">
                <div class="col-sm-2 col-xs-2">{vtranslate('LBL_WEBHOOK_URL',$QUALIFIED_MODULE)}<span class="redColor">*</span></div>
                <div class="col-sm-8 col-xs-8"><input type="text" class="form-control" data-validation-engine="validate[required]" name="url" value="{$TASK_OBJECT->url}" /></div>
        </div>
        <div class="row">
                <div class="col-sm-2 col-xs-2">{vtranslate('LBL_METHOD',$QUALIFIED_MODULE)}</div>
                <div class="col-sm-4 col-xs-4">
                        <select name="method" class="chzn-select form-control">
