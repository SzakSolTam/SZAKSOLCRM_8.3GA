	...
	<div class="blockHeader ruleHead" style="cursor: move;">
		...
		<div class="pull-right">
			...
			<div>
				...
				{assign var=ASSIGNED_TO_RULES_ARRAY value=array('CREATE_HelpDesk_FROM', 'CREATE_Leads_SUBJECT', 'CREATE_Contacts_SUBJECT', 'CREATE_Accounts_SUBJECT', 'CREATETO_Leads_SUBJECT', 'CREATETO_Contacts_SUBJECT', 'CREATETO_Accounts_SUBJECT')}
