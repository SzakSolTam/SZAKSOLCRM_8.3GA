...
{strip}
        <div class="row-fluid">
                <div class="span2">{vtranslate('LBL_WEBHOOK_URL',$QUALIFIED_MODULE)}<span class="redColor">*</span></div>
                <div class="span8"><input type="text" class="span8" data-validation-engine="validate[required]" name="url" value="{$TASK_OBJECT->url}" /></div>
        </div>
        <div class="row-fluid">
                <div class="span2">{vtranslate('LBL_METHOD',$QUALIFIED_MODULE)}</div>
                <div class="span4">
                        <select name="method" class="chzn-select">
