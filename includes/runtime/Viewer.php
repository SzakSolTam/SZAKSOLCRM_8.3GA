...
class Vtiger_Viewer extends SmartyBC
{
    ...
    {
        if (self::$overrideDefaultLayout !== null) {
            return self::$overrideDefaultLayout;
        }
     ...
     * @return string - Default Layout Name
     */
    public static function overrideDefaultLayoutName($layoutName)
    {
        self::$overrideDefaultLayout = $layoutName;
    }
